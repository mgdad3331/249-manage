...
# هذه الأعمدة ستتحول تلقائياً إلى نظام صحات (Ticks)
TICK_COLUMNS = [
    "الشهادات", "توثيقات", "معادلة", "التوكيل", "الرقم الوطني", "استلام الملف",
    "قبول مبدئي", "تسليم الملف", "رسوم الوافدين", "ترشيح نهائي", "172$" 
]
